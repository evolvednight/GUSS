    ...
    return (
      <div className="Page31">
        ...
        <div className="text">
          ...
          because of something else. Research: The way a scientist finds out the
          ...
          better ways to do things like treat illnesses. Research Study: A lot
          ...
          we write it down. Then we have an answer to our question! Sample: A
          ...
          to study it under a microscope. Science Experiment: Anything that you
