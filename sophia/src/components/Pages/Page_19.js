  ...
  render() {
    return (
      <div className="Page19">
        ...
        <div className="text">
        "Consent is when you agree to be in the study," answered Dr. Q. 
"It's when you say that you want to be in a study after you learn about what the study is. It's my job to tell you exactly what you would do if you were in the study. I have to tell you the good things that can happen and also the bad things. Then, you would decide if you wanted to do it.” 
